...
["projetgroupev1", "projetgroupev1.dart", , T, {
draw: function(context, lignes) {
  var i, t1;
  new T.draw_clear(context).call$0();
  for (i = 0; i < 35; ++i) {
    t1 = lignes[i];
    J.moveTo$2$x(t1.context, t1.xArr, t1.yArr);
    J.lineTo$2$x(t1.context, t1.xDep, t1.yDep);
    J.set$lineWidth$x(t1.context, 1);
    J.stroke$0$x(t1.context);
  }
},
...
attente: function() {
  var cerclesAtt, c1, c2, c3;
  cerclesAtt = P.List_List(3, null);
  c1 = new T.Cercle(175, 385, 15, null, null);
  c1.canvas = document.querySelector("#canvas");
  c1.context = J.getContext$1$x(c1.canvas, "2d");
  c2 = new T.Cercle(220, 385, 15, null, null);
  c2.canvas = document.querySelector("#canvas");
  c2.context = J.getContext$1$x(c2.canvas, "2d");
  c3 = new T.Cercle(265, 385, 15, null, null);
  c3.canvas = document.querySelector("#canvas");
  c3.context = J.getContext$1$x(c3.canvas, "2d");
  cerclesAtt[0] = c1;
  cerclesAtt[1] = c2;
  cerclesAtt[2] = c3;
  return cerclesAtt;
...
attToSer1: function() {
  var res, j, i, t1;
  res = P.List_List(79, null);
  for (j = 0, i = 445; i < 524; ++i) {
    t1 = new T.Cercle(i, 385, 15, null, null);
    t1.canvas = document.querySelector("#canvas");
    t1.context = J.getContext$1$x(t1.canvas, "2d");
    if (j >= 79)
      throw H.ioore(res, j);
    res[j] = t1;
    ++j;
...
main: function() {
  var t1, canvas, context, width, height, lignes, ligne1AtoF, ligne2AtoF, ligne1F, ligne2F, ligne3F, ligne4F, t2, t3, t4, ligne1FtoS1, t5, t6, ligne1FtoS2, ligneS1toS2, ligne1S1, ligne1S2, t7, ligne2S2, ligne2S1, ligne2S1toS2, ligne3S1, ligne3S2, ligne4S1, ligne4S2, ligneS1ToD, ligneS2ToD, ligne1Fhaut, ligne2Fhaut, ligne1haut, ligne2haut, lignehautToDec, ligne1hautToDec, ligne1SorToDec, ligne2SorToDec, ligneSorToDes, ligne1DecToDes, ligne2DecToDes, ligneToSor, ligneToDes, ligne1ToSor, ligne1ToDes, timer;
  t1 = {};
  canvas = document.querySelector("#canvas");
  context = J.getContext$1$x(canvas, "2d");
  width = canvas.width;
  height = canvas.height;
  lignes = P.List_List(35, null);
  ligne1AtoF = new T.ligne(140, 361, 300, 361, null, null);
  ligne1AtoF.canvas = document.querySelector("#canvas");
  ligne1AtoF.context = J.getContext$1$x(ligne1AtoF.canvas, "2d");
  ligne2AtoF = new T.ligne(140, 408, 300, 408, null, null);
  ligne2AtoF.canvas = document.querySelector("#canvas");
  ligne2AtoF.context = J.getContext$1$x(ligne2AtoF.canvas, "2d");
  ligne1F = new T.ligne(200, 361, 500, 361, null, null);
  ligne1F.canvas = document.querySelector("#canvas");
  ligne1F.context = J.getContext$1$x(ligne1F.canvas, "2d");
  ligne2F = new T.ligne(200, 408, 500, 408, null, null);
  ligne2F.canvas = document.querySelector("#canvas");
  ligne2F.context = J.getContext$1$x(ligne2F.canvas, "2d");
  ligne3F = new T.ligne(500, 361, 500, 270, null, null);
  ligne3F.canvas = document.querySelector("#canvas");
  ligne3F.context = J.getContext$1$x(ligne3F.canvas, "2d");
  ligne4F = new T.ligne(500, 408, 500, 510, null, null);
  ligne4F.canvas = document.querySelector("#canvas");
  ligne4F.context = J.getContext$1$x(ligne4F.canvas, "2d");
  ...
  if (typeof height !== "number")
    throw height.$div();
  t4 = height / 2;
  ligne1FtoS1 = new T.ligne(ligne3F.xArr, ligne3F.yArr, t3, t4 - 90, null, null);
  ligne1FtoS1.canvas = document.querySelector("#canvas");
  ligne1FtoS1.context = J.getContext$1$x(ligne1FtoS1.canvas, "2d");
  t5 = t2 - 40;
  t6 = t4 + 150;
  ligne1FtoS2 = new T.ligne(ligne4F.xArr, ligne4F.yArr, t5, t6, null, null);
  ligne1FtoS2.canvas = document.querySelector("#canvas");
  ligne1FtoS2.context = J.getContext$1$x(ligne1FtoS2.canvas, "2d");
  ligneS1toS2 = new T.ligne(550, 308, 550, 471, null, null);
  ligneS1toS2.canvas = document.querySelector("#canvas");
  ligneS1toS2.context = J.getContext$1$x(ligneS1toS2.canvas, "2d");
  ligne1S1 = new T.ligne(550, 471, 615, 471, null, null);
  ligne1S1.canvas = document.querySelector("#canvas");
  ligne1S1.context = J.getContext$1$x(ligne1S1.canvas, "2d");
  ligne1S2 = new T.ligne(550, 308, 615, 308, null, null);
  ligne1S2.canvas = document.querySelector("#canvas");
  ligne1S2.context = J.getContext$1$x(ligne1S2.canvas, "2d");
  t7 = t2 + 100;
  ligne2S2 = new T.ligne(t7, 463, 820, 463, null, null);
  ligne2S2.canvas = document.querySelector("#canvas");
  ligne2S2.context = J.getContext$1$x(ligne2S2.canvas, "2d");
  ligne2S1 = new T.ligne(t7, 312, 820, 312, null, null);
  ligne2S1.canvas = document.querySelector("#canvas");
  ligne2S1.context = J.getContext$1$x(ligne2S1.canvas, "2d");
  ligne2S1toS2 = new T.ligne(820, 312, 820, 463, null, null);
  ligne2S1toS2.canvas = document.querySelector("#canvas");
  ligne2S1toS2.context = J.getContext$1$x(ligne2S1toS2.canvas, "2d");
  ligne3S1 = new T.ligne(t7, 262, 875, 262, null, null);
  ligne3S1.canvas = document.querySelector("#canvas");
  ligne3S1.context = J.getContext$1$x(ligne3S1.canvas, "2d");
  ligne3S2 = new T.ligne(t7, 512, 875, 512, null, null);
  ligne3S2.canvas = document.querySelector("#canvas");
  ligne3S2.context = J.getContext$1$x(ligne3S2.canvas, "2d");
  ligne4S1 = new T.ligne(875, 262, 875, 362, null, null);
  ligne4S1.canvas = document.querySelector("#canvas");
  ligne4S1.context = J.getContext$1$x(ligne4S1.canvas, "2d");
  ligne4S2 = new T.ligne(875, 512, 875, 400, null, null);
  ligne4S2.canvas = document.querySelector("#canvas");
  ligne4S2.context = J.getContext$1$x(ligne4S2.canvas, "2d");
  ligneS1ToD = new T.ligne(875, 362, 913, 362, null, null);
  ligneS1ToD.canvas = document.querySelector("#canvas");
  ligneS1ToD.context = J.getContext$1$x(ligneS1ToD.canvas, "2d");
  ligneS2ToD = new T.ligne(875, 400, 913, 400, null, null);
  ligneS2ToD.canvas = document.querySelector("#canvas");
  ligneS2ToD.context = J.getContext$1$x(ligneS2ToD.canvas, "2d");
  ligne1Fhaut = new T.ligne(327, 442, 327, 595, null, null);
  ligne1Fhaut.canvas = document.querySelector("#canvas");
  ligne1Fhaut.context = J.getContext$1$x(ligne1Fhaut.canvas, "2d");
  ligne2Fhaut = new T.ligne(377, 442, 377, 555, null, null);
  ligne2Fhaut.canvas = document.querySelector("#canvas");
  ligne2Fhaut.context = J.getContext$1$x(ligne2Fhaut.canvas, "2d");
  ligne1haut = new T.ligne(327, 595, 1065, 595, null, null);
  ligne1haut.canvas = document.querySelector("#canvas");
  ligne1haut.context = J.getContext$1$x(ligne1haut.canvas, "2d");
  ligne2haut = new T.ligne(377, 555, 1010, 555, null, null);
  ligne2haut.canvas = document.querySelector("#canvas");
  ligne2haut.context = J.getContext$1$x(ligne2haut.canvas, "2d");
  lignehautToDec = new T.ligne(1010, 555, 1010, 350, null, null);
  lignehautToDec.canvas = document.querySelector("#canvas");
  lignehautToDec.context = J.getContext$1$x(lignehautToDec.canvas, "2d");
  ligne1hautToDec = new T.ligne(1065, 595, 1065, 350, null, null);
  ligne1hautToDec.canvas = document.querySelector("#canvas");
  ligne1hautToDec.context = J.getContext$1$x(ligne1hautToDec.canvas, "2d");
  ligne1SorToDec = new T.ligne(1291, 288, 1133, 288, null, null);
  ligne1SorToDec.canvas = document.querySelector("#canvas");
  ligne1SorToDec.context = J.getContext$1$x(ligne1SorToDec.canvas, "2d");
  ligne2SorToDec = new T.ligne(1133, 288, 1133, 343, null, null);
  ligne2SorToDec.canvas = document.querySelector("#canvas");
  ligne2SorToDec.context = J.getContext$1$x(ligne2SorToDec.canvas, "2d");
  ligneSorToDes = new T.ligne(1190, 336, 1190, 420, null, null);
  ligneSorToDes.canvas = document.querySelector("#canvas");
  ligneSorToDes.context = J.getContext$1$x(ligneSorToDes.canvas, "2d");
  ligne1DecToDes = new T.ligne(1133, 355, 1133, 464, null, null);
  ligne1DecToDes.canvas = document.querySelector("#canvas");
  ligne1DecToDes.context = J.getContext$1$x(ligne1DecToDes.canvas, "2d");
  ligne2DecToDes = new T.ligne(1133, 464, 1291, 464, null, null);
  ligne2DecToDes.canvas = document.querySelector("#canvas");
  ligne2DecToDes.context = J.getContext$1$x(ligne2DecToDes.canvas, "2d");
  ligneToSor = new T.ligne(1190, 336, 1341, 336, null, null);
  ligneToSor.canvas = document.querySelector("#canvas");
  ligneToSor.context = J.getContext$1$x(ligneToSor.canvas, "2d");
  ligneToDes = new T.ligne(1190, 420, 1341, 420, null, null);
  ligneToDes.canvas = document.querySelector("#canvas");
  ligneToDes.context = J.getContext$1$x(ligneToDes.canvas, "2d");
  ligne1ToSor = new T.ligne(1341, 336, 1341, 285, null, null);
  ligne1ToSor.canvas = document.querySelector("#canvas");
  ligne1ToSor.context = J.getContext$1$x(ligne1ToSor.canvas, "2d");
  ligne1ToDes = new T.ligne(1341, 420, 1341, 465, null, null);
  ligne1ToDes.canvas = document.querySelector("#canvas");
  ligne1ToDes.context = J.getContext$1$x(ligne1ToDes.canvas, "2d");
  lignes[0] = ligne1AtoF;
  lignes[1] = ligne2AtoF;
  lignes[2] = ligne1F;
  lignes[3] = ligne2F;
  ...
  T.draw(context, lignes);
  J.drawImage$3$x(context, document.querySelector("#arrivee"), 50, t4);
  context.drawImage(document.querySelector("#fpeps"), 300, t4);
  context.drawImage(document.querySelector("#fhaut"), 300, t4 + 48);
  context.drawImage(document.querySelector("#serveur1"), t5, t4 - 100);
  context.drawImage(document.querySelector("#fdroite"), t3, t4 - 112);
  context.drawImage(document.querySelector("#serveur2"), t5, t4 + 100);
  context.drawImage(document.querySelector("#fdroite"), t2 - 87, t4 + 90);
  t5 = t4 - 20;
  context.drawImage(document.querySelector("#decision"), t2 + 250, t5);
  context.drawImage(document.querySelector("#fdroite"), t2 + 212, t5);
  t5 = width - 150;
  context.drawImage(document.querySelector("#sortie"), t5, t4 - 150);
  context.drawImage(document.querySelector("#fhaut"), width - 136, t4 - 109);
  context.drawImage(document.querySelector("#destruction"), t5, t6);
  context.drawImage(document.querySelector("#fbas"), width - 138, t4 + 105);
  T.drawPath(context, T.attente());
  t1.i_0 = 0;
  timer = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 2), new T.main_closure(t1));
  if (t1.i_0 === 6)
    timer.cancel$0();
},

Cercle: {"": "Object;x,y,r,canvas,context",
  draw$0: function() {
    J.beginPath$0$x(this.context);
    J.set$fillStyle$x(this.context, "#009000");
    J.set$strokeStyle$x(this.context, "#000000");
    J.set$lineWidth$x(this.context, 1);
    J.arc$6$x(this.context, this.x, this.y, this.r, 0, 6.283185307179586, true);
  ...
  delete$0: function() {
    J.beginPath$0$x(this.context);
    J.set$fillStyle$x(this.context, "#ffffff");
    J.set$strokeStyle$x(this.context, "#ffffff");
    J.set$lineWidth$x(this.context, 0);
    J.arc$6$x(this.context, this.x, this.y, this.r, 0, 6.283185307179586, true);
    J.stroke$0$x(this.context);
    J.closePath$0$x(this.context);
    J.fill$0$x(this.context);
...
ligne: {"": "Object;xDep,yDep,xArr,yArr,canvas,context"},

draw_clear: {"": "Closure;context_0",
  call$0: function() {
    var t1, t2;
    t1 = this.context_0;
    J.set$fillStyle$x(t1, "#ffffff");
    t2 = t1.canvas;
...
function dart_precompiled($collectedClasses) {
  ...
  function Cercle(x, y, r, canvas, context) {
    this.x = x;
    this.y = y;
    this.r = r;
    this.canvas = canvas;
  ...
  Cercle.builtin$cls = "Cercle";
  if (!"name" in Cercle)
    Cercle.name = "Cercle";
  $desc = $collectedClasses.Cercle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Cercle.prototype = $desc;
  function ligne(xDep, yDep, xArr, yArr, canvas, context) {
    this.xDep = xDep;
    this.yDep = yDep;
    this.xArr = xArr;
    this.yArr = yArr;
  ...
  ligne.builtin$cls = "ligne";
  if (!"name" in ligne)
    ligne.name = "ligne";
  $desc = $collectedClasses.ligne;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ligne.prototype = $desc;
  function draw_clear(context_0) {
    this.context_0 = context_0;
  }
  draw_clear.builtin$cls = "draw_clear";
  if (!"name" in draw_clear)
    draw_clear.name = "draw_clear";
  $desc = $collectedClasses.draw_clear;
  if ($desc instanceof Array)
    $desc = $desc[1];
  draw_clear.prototype = $desc;
